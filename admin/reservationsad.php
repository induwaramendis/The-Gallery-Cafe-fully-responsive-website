...
if(isset($_GET['delete'])){
   ...
   header('location:reservationsad.php');
}
?>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="reservationsad.php?delete=<?= $fetch_table_reservation['id']; ?>" class="delete-btn" onclick="return confirm('delete this reservation?');">delete</a>
         </div> 
